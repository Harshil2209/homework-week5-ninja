...
public class MyAccountTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        registerPage.sendFirstName("Hardy");
        //3.4 Enter Last Name
        registerPage.sendLastName("Patel");
        //3.5 Enter Email
        registerPage.sendEmail("patel");
        //3.6 Enter Telephone
        registerPage.sendTelephone("07796649507");
        //3.7 Enter Password
        registerPage.sendPassword("Harry1234");
        //3.8 Enter Password Confirm
        registerPage.sendConfirmPassword("Harry1234");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        homePage.selectMyAccountOptions("Login");
        //4.3 enter email
        loginPage.sendEmail("harry@gmail.com");
        //enter password
        loginPage.sendPassword("Harry1234");
        //click login
